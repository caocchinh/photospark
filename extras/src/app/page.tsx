...
export default async function Home() {
  ...
  return (
    <div className="w-full min-h-screen mx-auto p-10 pt-4 ">
      <TextShimmer
        className=" text-2xl font-semibold mb-2 text-center uppercase flex justify-center items-center  [--base-color:black] [--base-gradient-color:gray]"
        duration={5}
        spread={4}
      >
        Quản lý in ảnh
      </TextShimmer>
      <p className="text-center text-rose-400">Hãy chắc chắn khách hàng đã trả tiền trước khi in ảnh!</p>
