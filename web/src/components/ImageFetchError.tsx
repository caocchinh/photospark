    ...
    <Dialog defaultOpen={true}>
      <DialogContent className="flex flex-col items-center justify-center gap-4 border border-red-500 min-h-[330px]">
        <div className="flex flex-col items-center justify-center gap-4">
          <DialogTitle className="text-red-500 text-3xl font-semibold text-center uppercase">Lỗi khi load ảnh</DialogTitle>
          <MdOutlineHideImage size={100} />
...
export default ImageFetchError;
