  ...
  resources: {
    ...
    vi: {
      translation: {
        ...
        "Please go outside to take the photo": "Hãy đi ra ngoài lấy hình nhé!",
        "Random filter": "Filter ngẫu nhiên",
        "Click on image to unselect": "Bấm vào hình không thích để xóa",
        "Drag to switch images position": "Kéo để đổi vị trí hình hình",
        ...
        "Edit image": "Sửa hình",
        "Print more": "In thêm",
        "Error while downloading image!": "Có lỗi trong khi download hình!",
        "Order ID": "Mã đơn hàng",
        "Image type": "Loại hình",
        Quantity: "Số lượng",
        Price: "Giá",
        Time: "Thời gian",
        Back: "Quay lại",
